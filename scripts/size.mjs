...
// nextSibling bridging plan↔real DOM), slice 3a (deferred `ref` firing with the
// adopted node; a `ref` op is now on the RenderBackend, +~1 gz to dom/server too,
// absorbed in their bumps), and slice 3b (splitText to adopt adjacent text pieces
// the parser coalesced — the last blocker for claiming klarum's showcase; 2375→2425).
// Foundational, not bloat.
const fixtures = {
  ...
  "hydrate: claim": [`import { claim } from "pimas/hydrate"; globalThis.x = claim;`, 2425],
